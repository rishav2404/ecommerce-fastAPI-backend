...
class ProductService:
    ...
    async def update_product_inventory(self, product_id: str, size: str, quantity_used: int) -> bool:
        """
    ...
    async def check_product_availability(self, product_id: str, quantity: int) -> tuple[bool, float]:
        """
